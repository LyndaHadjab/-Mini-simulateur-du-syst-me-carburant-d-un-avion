...
bool moteur::estalimenter()//retourner la valeur qui indique si
//le moteur est alimenter ou nou (avec la variable verif si alimenter
{
    return verifsialimenter;
}
Reservoire* moteur::AdresseSonreservoire()//adresse du reservoire qui l'alimente
{
    return sonreservoire;
}
void moteur::initialisermoteur(Reservoire* reser,int quantite)//changer la quatiter d consommation
{
...
{
    //si le reservoire est alimenter alors on
    //return le nom du reservoire alimentant sinon aucun reservoire ne l alimente
    if(verifsialimenter)
